...
function getStatusBadge($status) {
    $badges = [
        ...
        'Partially Paid' => '<span class="px-2 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300">Partially Paid</span>',
