...
<div x-data="{ 
    ...
    openModal(title, message, action) {
     ...
     @open-modal.window="openModal($event.detail.title, $event.detail.message, $event.detail.action)">
                ...
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white" id="modal-title" x-text="modalTitle"></h3>
                            <div class="mt-2">
